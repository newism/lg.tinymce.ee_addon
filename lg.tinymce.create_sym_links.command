...
ln -s "$dirname"/system/extensions/ext.lg_tinymce.php "$ee_path"/"$ee_system_folder"/extensions/ext.lg_tinymce.php
ln -s "$dirname"/system/language/english/lang.lg_tinymce.php "$ee_path"/"$ee_system_folder"/language/english/lang.lg_tinymce.php
